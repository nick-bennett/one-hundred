...
public class Main {
  ...
  private static void playOnce(String[] args, ResourceBundle bundle, Game.State state,
      GamePresentation<String> presentation) throws StrategyInitializationException {
